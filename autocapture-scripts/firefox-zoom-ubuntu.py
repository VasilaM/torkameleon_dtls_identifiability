...
INTERFACE = "eth0"
DISPLAY_FILTER = "dtls"
CAPTURE_DIR = "../discord_pcap/ubuntu/firefox"
GECKO_DRIVER_PATH = "/snap/bin/geckodriver"

def automate_capture():
    profile_path = "/home/vasila/selenium_profiles/iw_test_profile-2"
    ...
    try:
        for iteration in range(28, 51):
            ...
            print(f"terminated capture: {output_file}, writing to ubuntu_zoom_firefox_{iteration}.pcap ")
